...
public class JosekiQueryServiceLocator extends org.apache.axis.client.Service implements org.joseki.ws.JosekiQueryService {
    ...
    public org.joseki.ws.JosekiQuery getWSQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.joseki.ws.WSQuerySoapBindingStub _stub = new org.joseki.ws.WSQuerySoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.joseki.ws.JosekiQuery.class.isAssignableFrom(serviceEndpointInterface)) {
                org.joseki.ws.WSQuerySoapBindingStub _stub = new org.joseki.ws.WSQuerySoapBindingStub(new java.net.URL(WSQuery_address), this);
                _stub.setPortName(getWSQueryWSDDServiceName());
                return _stub;
            }
        }
